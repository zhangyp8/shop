			...
			<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
				...
				<c:if test="${page!=pageBean.currentPage }">
					<li style="text-align: center;"><a
						href="${pageContext.request.contextPath }/productList?cid=${cid }&currentPage=${page }">${page }</a></li>
				</c:if>
			</c:forEach>
		...
		<div style="overflow: hidden;">
			...
			<c:forEach items="${historyProductList }" var="historyPro">
				<li
					...
					<img src="${pageContext.request.contextPath }/${historyPro.pimage }" width="130px" height="130px" /><br>
					<span>${historyPro.pname }</span>
					</li>
