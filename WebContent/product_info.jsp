...
<script type="text/javascript">
	function sendProToCar() {
		var buyNum = $("#buyNum").val();
		location.href="${pageContext.request.contextPath}/productCar?pid=${productInfo.pid}&buyNum="+buyNum;
	}
</script>
</head>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${productInfo.shop_price }元</strong> 参 考 价：
					...
					<div
						...
						<div style="margin: 5px 0 10px 0;">${productInfo.pname }</div>
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javaScript:void(0);" onclick="sendProToCar()"> <input
						...
						style="margin-left: 75px">返回上一页</a>
						</c:if>
						<c:if test="${!empty currentPage }">
						<a href="${pageContext.request.contextPath }/productList?pid=${productInfo.pid }&cid=${productInfo.cid }&currentPage=${currentPage }"
						style="margin-left: 75px">返回上一页</a>
						</c:if>
					</div>
				</div>
