...
<body>
	...
	<div class="container">
					...
					<tbody>
						...
						<tr class="active">
							<td width="60" width="40%"><input type="hidden" name="id"
								...
								height="60"></td>
							<td width="30%"><a href="${pageContext.request.contextPath }/productInfo?pid=${orderItem.product.pid }">${orderItem.product.pname }</a></td>
		...
		<div>
			<hr />
			<form class="form-horizontal" id="submitOrder" action="${pageContext.request.contextPath }/submitOrder?oid=${order.oid }" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="confirmpwd" value="${order.telephone }" name = "telephone"
							placeholder="请输入联系方式">
					</div>
				</div>
